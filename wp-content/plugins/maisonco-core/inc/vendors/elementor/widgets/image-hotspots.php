...
class OSF_Elementor_Image_Hotspots_Widget extends Widget_Base {
    ...
    public function get_css_config() {
        return $this->get_widget_css_config( 'accordion' );
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control('hotspot_icon_color', [
            'label'     => esc_html__('Icon Color', 'maisonco-core'),
            'type'      => Controls_Manager::COLOR,
            'selectors' => [
                '{{WRAPPER}} {{CURRENT_ITEM}} .hotspot-icon' => 'color: {{VALUE}}'
            ]
        ]);
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'vh'],
                'selectors'  => [
                    '{{WRAPPER}} .opal-image-hotspots-container .opal-addons-image-hotspots-ib-img' => 'height: {{SIZE}}{{UNIT}}; object-fit: cover; ',
                ],
                'separator'  => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['%', 'px', 'vw'],
                'selectors'  => [
                    '{{WRAPPER}} .opal-image-hotspots-container .opal-addons-image-hotspots-ib-img' => 'width: {{SIZE}}{{UNIT}}; ',
                ],
                'separator'  => 'before',
            ]
        );
        ...
        $this->start_controls_section('image_hotspots_icons_style_settings',
            [
                'label' => esc_html__('ICONS', 'maisonco-core'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );

        $this->add_control('image_hotspots_icon_size',
            [
                'label'     => esc_html__('Icon Size', 'maisonco-core'),
                'type'      => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
                ...
                'size_units' => [ 'px', 'em', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .hotspot-icon' => 'font-size: {{SIZE}}{{UNIT}};'
                ]
            ]
        );
                        ...
                        <a class="opal-image-hotspots-tooltips-link" href="<?php echo esc_url($link_url); ?>"
                           ...
                           <?php endif; ?><?php if (!empty($item['image_hotspots_url']['nofollow'])) : ?>rel="nofollow"<?php endif; ?>>
                            ...
                            if (!empty($item['hotspot_icon']['value'])) {
                                Icons_Manager::render_icon($item['hotspot_icon'], ['aria-hidden' => 'true','class'=>'hotspot-icon']);
                            } else {
                                ?>
