...
class OSF_Elementor_CallToAction extends Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Call to Action', 'maisonco-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				'label' => __( 'Horizontal Position', 'maisonco-core' ),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => false,
				'options' => [
					'left' => [
...
//                'default'   => 'no',
		...
		$this->add_responsive_control(
			'min-height',
			[
				'label' => __( 'Min. Height', 'maisonco-core' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 100,
		...
		$this->add_responsive_control(
			'image_min_width',
			[
				'label' => __( 'Min. Width', 'maisonco-core' ),
				'type' => Controls_Manager::SLIDER,
				'range' => [
					'px' => [
						'min' => 0,
		...
		$this->add_control(
			'description_color',
			[
				'label' => __( 'Description Color', 'maisonco-core' ),
				'type' => Controls_Manager::COLOR,
				'selectors' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementor-cta__button' => 'border-style: {{VALUE}};',
                ],
            ]
        );
		...
		$this->start_controls_section(
			'img_hover_effects',
			[
				'label' => __( 'Image Hover Effects', 'maisonco-core' ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'groups' => [
					[
						'label' => __( 'None', 'maisonco-core' ),
						'options' => [
							'' => __( 'None', 'maisonco-core' ),
						],
					],
					[
						'label' => __( 'Entrance', 'maisonco-core' ),
						'options' => [
					...
					[
						'label' => __( 'Reaction', 'maisonco-core' ),
						'options' => [
							'grow' => 'Grow',
							'shrink' => 'Shrink',
		...
		$this->add_control(
			'sequenced_animation',
			[
				'label' => __( 'Sequenced Animation', 'maisonco-core' ),
				'type' => Controls_Manager::SWITCHER,
