...
class OSF_Elementor_Addons {
    public function __construct() {
        ...
        add_action('elementor/frontend/after_enqueue_scripts', [$this, 'regeister_scripts_frontend']);
        add_action('wp_enqueue_scripts', array($this, 'regeister_scripts_override'), 15);
    ...
    function regeister_scripts_override() {
