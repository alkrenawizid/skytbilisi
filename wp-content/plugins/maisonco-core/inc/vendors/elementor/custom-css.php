...
class Opal_Elementor_Custom_Css {
    ...
    public function add_scripts_editor() {
        wp_enqueue_script( 'opal-elementor-custom-css', trailingslashit(MAISONCO_CORE_PLUGIN_URL) . '/assets/js/elementor/elementor-custom-css.js', [], MAISONCO_CORE_VERSION, true );
    }
    ...
    public function register_controls( Controls_Stack $element, $section_id ) {
        ...
        $element->start_controls_section(
            'section_custom_css',
            [
                'label' => esc_html__( 'Custom CSS', 'maisonco-core' ),
                'tab' => $old_section['tab'],
            ]
        );
        ...
        $element->add_control(
            'custom_css_title',
            [
                'raw' => esc_html__( 'Add your own custom CSS here', 'maisonco-core' ),
        ...
        $element->add_control(
            ...
            [
                'raw' => wp_kses_post(__( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'maisonco-core' )),
                'type' => Controls_Manager::RAW_HTML,
...
return new Opal_Elementor_Custom_Css();
