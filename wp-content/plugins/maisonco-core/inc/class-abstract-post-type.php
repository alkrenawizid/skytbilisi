...
abstract class OSF_Custom_Post_Type_Abstract {
    ...
    public function __construct() {
        ...
        $this->link_image = trailingslashit(MAISONCO_CORE_PLUGIN_URL) . 'assets/images/customize/';
        $this->options = array(
    ...
    public function get_icon($name) {
        ...
        if (file_exists(MAISONCO_CORE_PLUGIN_DIR . '/assets/images/post-type/' . $name . '.png')) {
            return MAISONCO_CORE_PLUGIN_URL . '/assets/images/post-type/' . $name . '.png';
        } else {
